  ...
  <div class="app_first">
    ...
    <div>
        ...
        <div class="block">
            ...
            <span class="week" v-text="weekText" v-bind="weekText"></span>
        ...
        <table border="1" cellspacing="0">
          <tr>
            <td v-for = "(item,index) in items"  v-bind:key="index">
              ...
              <!-- 周几 -->
              <span v-bind="which_weekDay" v-if="(which_weekDay+index)<7">{{ dayNames[which_weekDay+index]}}</span>
          ...
          <tr class="td_65px">
            ...
            <td v-for="(item,week_index) in items" v-bind:key="week_index">
